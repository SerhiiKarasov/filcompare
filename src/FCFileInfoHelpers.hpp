...
constexpr uint32_t readFileOwner(const struct stat &mFileStat) noexcept;
constexpr uint32_t readFileOwnerGroup(const struct stat &mFileStat) noexcept;
constexpr uint64_t readFileSize(const struct stat &mFileStat) noexcept;
constexpr uint32_t readFilePerms(const struct stat &mFileStat) noexcept;
...
constexpr uint64_t FCFileInfoHelpers::readFileSize(const struct stat &mFileStat) noexcept
{
    return mFileStat.st_size;
}

constexpr uint32_t FCFileInfoHelpers::readFilePerms(const struct stat &mFileStat) noexcept
{
...
constexpr uint32_t FCFileInfoHelpers::readFileOwner(const struct stat &mFileStat) noexcept
{
    return mFileStat.st_uid;
}

constexpr uint32_t FCFileInfoHelpers::readFileOwnerGroup(const struct stat &mFileStat) noexcept
{
